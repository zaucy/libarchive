def main [registry_dir: string] {
	...
	git diff v3.7.3..HEAD **/*.bazel **/*.bzl .bazelrc bazel/BUILD.bazel libarchive_bazel_windows_config.h libarchive_bazel_generic_config.h | save ($patches_dir | path join 'build_with_bazel.patch') -f;
